...
import 'package:htpts_app/screen/main_page.dart';

class AppDescription3 extends StatelessWidget {
  const AppDescription3({super.key});
              ...
              Positioned(
                ...
                child: Row(
                  children: [
                    ...
                    const SizedBox(width: 16),
                    _buildCircle(3, true), // 3번: 검은 배경, 흰 글씨
                  ],
                ),
              ),
              // "그림 그리기" 텍스트
                  ...
                  child: Container(
                    ...
                    decoration: const BoxDecoration(
                      image: DecorationImage(
                        image: AssetImage(
                            'assets/images/I.png'), // assets에서 이미지 불러오기
                        fit: BoxFit.fill,
                      ),
                    ),
                  ),
